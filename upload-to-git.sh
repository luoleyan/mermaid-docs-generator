...
sed -i "s|\"homepage\": \"https://github.com/yourusername/mermaid-docs-generator#readme\"|\"homepage\": \"https://github.com/$USERNAME/$REPO_NAME#readme\"|g" package.json
sed -i "s|\"url\": \"git+https://github.com/yourusername/mermaid-docs-generator.git\"|\"url\": \"git+$REPO_URL\"|g" package.json
sed -i "s|\"url\": \"https://github.com/yourusername/mermaid-docs-generator/issues\"|\"url\": \"https://github.com/$USERNAME/$REPO_NAME/issues\"|g" package.json
